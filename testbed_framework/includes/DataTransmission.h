...
class DataTransmission
{
    ...
    int sendPacketRADIO(serial_source src, int radio_dst, packetType pt, int imgID);
...
public:
	...
	int sendImgInfoRADIO(serial_source src, int radio_dst, int imgID, bool atc_cta,
	...
	int sendFeaturesRADIO(serial_source src, int radio_dst, int imgID, int nFeats, vector<uchar> kpts_bitstream, vector<uchar> feats_bitstream);
	int sendJpegRADIO(serial_source src, int radio_dst, int imgID, vector<uchar> jpeg_bitstream);
	int sendACK_RADIO(serial_source src, int radio_dst, ackType at, int imgID, actions *acts = NULL);
	int sendCMD_RADIO(serial_source src, int radio_dst, commandType ct, actions *acts = NULL);
